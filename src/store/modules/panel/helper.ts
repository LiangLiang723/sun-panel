...
const defaultFooterHtml = '<div class="flex justify-center text-slate-300" style="margin-top:100px">Powered By <a href="https://github.com/LiangLiang723/sun-panel" target="_blank" class="ml-[5px]">Sun-Panel</a></div>'
